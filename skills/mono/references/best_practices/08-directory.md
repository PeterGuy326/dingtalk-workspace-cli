...
- **角色/职责类查人走 aisearch**：用户说"角色为XX的员工"、"XX角色的人员"、"所有主管/管理员/财务/HR"等诉求时，统一用 `dws aisearch person --keyword "<角色或职责>" --dimension duty --format json`。`contact label` 后端工具已下线，不要主动使用。
