...
#
# Fork-only delivery installer for remove-discovery + default-yolo.
#
# Usage:
...
#   DWS_VERSION         release tag to install (default: delivery-remove-discovery-yolo-latest)
...
VERSION="${DWS_VERSION:-delivery-remove-discovery-yolo-latest}"
...
printf '\n'
say "DWS delivery installer: remove-discovery + default-yolo"
say "repo:    ${REPO}"
say "version: ${VERSION}"
say "target:  ${OS}/${ARCH}"
printf '\n'
